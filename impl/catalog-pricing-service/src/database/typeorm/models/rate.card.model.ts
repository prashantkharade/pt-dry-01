...
export class RateCard {
    ...
    @Column({ name: 'Rate', type: 'numeric', precision: 15, scale: 2 })
    Rate: string;

    @Column({ name: 'Uom', type: 'varchar', length: 16, default: 'piece' })
    Uom: string;
    ...
    @Column({ name: 'IsVendorRate', type: 'boolean', default: false })
