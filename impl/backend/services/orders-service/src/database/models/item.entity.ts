...
export class Item {
  ...
  @Column({ name: 'CategoryId', type: 'uuid' }) CategoryId!: string;
  @Column({ name: 'Code', type: 'varchar', length: 64 }) Code!: string;
  ...
  @Column({ name: 'ApplicableServices', type: 'text', array: true }) ApplicableServices!: string[];
  @Column({ name: 'DefaultUom', type: 'varchar', length: 16, default: 'piece' }) DefaultUom!: string;
  @Column({ name: 'IsVendorOnly', type: 'boolean', default: false }) IsVendorOnly!: boolean;
