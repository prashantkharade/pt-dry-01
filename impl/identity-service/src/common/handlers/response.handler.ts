...
/////////////////////////////////////////////////////////////////////////
//  Standard envelope used across every endpoint. Keep the shape stable
//  — clients (admin portal, Flutter app, sister services) depend on it.
/////////////////////////////////////////////////////////////////////////
...
export class ResponseHandler {
    ...
    public static success(
        ...
        message : string,
        httpCode: number = HttpStatusCodes.OK,
        data?   : any,
    ): express.Response {
