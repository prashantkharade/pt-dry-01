...
//
//  DataSource is built lazily inside connect() so dotenv.config() in
//  index.ts has run before we read process.env. On connect, the target
//  database is auto-created if missing (postgres & mysql).
/////////////////////////////////////////////////////////////////////////

const ENTITIES = [NotificationTemplate, NotificationLog];
