...
export class NotificationsServiceConnector {
    ...
    private headers(): Record<string, string> {
        return {
            ...
            //orders-service is in notifications' AllowedClients list for
            ///send-template. No user token: these fire off domain events with
            //no user in scope, so TenantId travels in the body.
