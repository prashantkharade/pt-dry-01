...
import { Configurations, PaymentProvider } from './configuration.types';
...
export class ConfigurationManager {
    ...
    public static get PrimaryPayment(): PaymentProvider   { return ConfigurationManager._config.Payments.Primary; }
    public static get SecondaryPayment(): PaymentProvider { return ConfigurationManager._config.Payments.Secondary; }
