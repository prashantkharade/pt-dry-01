...
import { register as registerPaymentRoutes } from '../api/payments/payment.routes';
import { register as registerWebhookRoutes } from '../api/webhooks/webhook.routes';
...
export class Router {
    ...
    public init = async (): Promise<boolean> => {
        ...
        registerWebhookRoutes(this._app);
        return true;
    };
}
